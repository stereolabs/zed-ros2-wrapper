...
- [ZED SDK](https://www.stereolabs.com/developers/release/latest/) v5.1 (for support for older versions please check the [releases](https://github.com/stereolabs/zed-ros2-wrapper/releases))
